...
public class MasterSocket {
	...
	for (int i=0; i<numWorkers; i++){
	   ...
	   reader[i] = new BufferedReader( new InputStreamReader(sockets[i].getInputStream()));// interface vers le flux d'entrée du socket
	   writer[i] = new PrintWriter(new BufferedWriter(new OutputStreamWriter(sockets[i].getOutputStream())),true);//interface vers le flux de sorte du socket
       }
